...
class POICVideo(Video):
    ...
    def __init__(self,name,root,video_dir,init_rect,img_names,gt_rect,load_img=False):
        super(POICVideo,self).__init__(name,root,video_dir,init_rect,img_names,gt_rect,load_img=load_img)
    ...
    def load_tracker(self, path, tracker_names=None, store=True):
        ...
        :return:
        """
        # print('img_names', len(self.img_names))
            ...
            if os.path.exists(traj_file):
                with open(traj_file, 'r') as f :
                    pred_traj = [list(map(float, x.strip().split(' ')))
                                 for x in f.readlines()[:len(self.img_names)]]
...
class POICDataset(Dataset):
    def __init__(self, name, dataset_root, load_img=False):
        super(POICDataset,self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            self.videos[video] = POICVideo(video,
                                          dataset_root,
