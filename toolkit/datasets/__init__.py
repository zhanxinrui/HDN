...
from .DeepHomo import DeepHomoTestDataset, DeepHomoTrainDataset
from .poic import POICDataset
from .ucsb import UCSBDataset
class DatasetFactory(object):
    ...
    def create_dataset(**kwargs):
        ...
        if 'OTB' in name:
            ...
            dataset = POTDataset(**kwargs)
        elif 'DeepHomoTest' == name:
            dataset = DeepHomoTestDataset(**kwargs)
        elif 'DeepHomoTrain' == name:
            dataset = DeepHomoTrainDataset(**kwargs)
        elif 'POIC' == name:
            dataset = POICDataset(**kwargs)
        elif 'UCSB' == name:
            dataset = UCSBDataset(**kwargs)
        else:
