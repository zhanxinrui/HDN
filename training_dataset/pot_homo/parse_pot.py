...
parser.add_argument('--dir',type=str, default=cfg.BASE.BASE_PATH + 'hdn_liyang/hdn/training_dataset/pot_homo/POT_train_homo/', help='your POT data dir')
args = parser.parse_args()

pot_base_path = args.dir
if not osp.exists(pot_base_path):
    os.makedirs(pot_base_path)
pot = []
